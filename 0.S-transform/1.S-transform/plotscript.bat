...
REM %9 INTERVAL OF X-AXIS
REM %10 INTERVAL OF COLOR-BAR
REM --------------

REM SET PARAMETER 
REM set B1=-Bf20a20::wS
set B1=-Bf%9a%9::wS
REM set B2=-Bf20a20:"Time [s]":/f2.5a2.5:"Frequency [Hz]"::.:WSne
set B2=-Bf%9a%9:"Time [s]":/f2.5a2.5:"Frequency [Hz]"::.:WSne
set B3=-B0.25:" "::.:
set J1=-JX7./1.0
set J2=-JX7./3.
REM -------------
...
REM echo gridding ...
gawk "{print $1,$2,$3}" %2 | xyz2grd -Ggrd.grd -I%6/%7 %4 -N0. -V -f
REM -------------------------
grdinfo grd.grd

REM MAKE COLOR PALETTE
REM makecpt -Cseis %5/0.05 -Z -I -N0. -V > cpt.cpt
REM makecpt -Csealand %5/0.05 -Z  -N0. -V > cpt.cpt
REM echo 0.5 0  0 205    0.7 0 250 250 > cpt.cpt
REM echo 0.7 0  250 250  0.9 250  250 0 >> cpt.cpt
REM echo 0.9 250  250 0  1.0 200 0 0 >> cpt.cpt
...
psscale -Ccpt.cpt -D3.5/3.5/6.c/.5ch -O -K %B3% >> %8
REM ------------------
