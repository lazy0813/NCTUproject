c---------------------------------------------------------------------
      SUBROUTINE readsac(fn,np,dt,xc,yy,iday,hh,oo,sec)
c             readsac(fn,np,dt,xc,yy,iday,hh,oo,sec,stn,rd,comp)
        	type sacheader
...
c   Record information
		...
		sh%sac_header_integer(8:9)=0
        	...
        	sh%sac_header_real(32)=sla
        	sh%sac_header_real(33)=slo
        	sh%sac_header_real(34)=elv
